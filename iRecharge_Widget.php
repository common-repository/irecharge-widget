 ...
 * Plugin URI: http://wordpress.org/plugins/irecharge-widget
...
<?php
 ...
 // WP_Widget_iRecharge is the class that handles the main widget.

class WP_Widget_iRecharge extends WP_Widget {

    public function __construct () {

        $widget_ops = array( 'description' => __( 'Instant top up', 'text_domain' ), );
        $name = "iRecharge";

        parent::__construct( 'iRecharge', $name, $widget_ops );
...
function ist_ir_register_shortcodes() {
    add_shortcode('irecharge','iRecharge');
}
...
function register_iRecharge_widget() {
    register_widget( 'WP_Widget_iRecharge' );
}
add_action( 'widgets_init', 'register_iRecharge_widget' );
add_action('wp', 'irecharge_ext_init');
add_action('admin_menu', 'ist_irecharge_admin_actions');
add_action('admin_init', 'ist_irecharge_init');
